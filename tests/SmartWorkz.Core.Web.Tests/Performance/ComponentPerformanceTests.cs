...
namespace SmartWorkz.Core.Web.Tests.Performance;
...
public class ComponentPerformanceTests
{
    ...
    public void ModalOpenCloseAnimation_PerformsConsistently()
    {
        ...
        const long maxTotalAnimationTimeMs = 1000; // Total for all cycles
        const long maxSingleCycleTimeMs = 25; // Per cycle (open + close)
    ...
    public void ComprehensivePerformanceBaseline_EstablishedSuccessfully()
    {
        ...
        baseline.ModuleRenderTime = stopwatch.ElapsedMilliseconds;
...
This baseline should be used to compare performance in future builds.";
    ...
    private class PerformanceBaseline
    {
        ...
        /// <summary>Time to render grid module in milliseconds</summary>
        public long GridModuleRenderTime { get; set; }
