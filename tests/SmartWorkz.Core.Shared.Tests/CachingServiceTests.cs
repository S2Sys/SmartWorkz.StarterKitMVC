...
public class CachingServiceTests
{
    ...
    public async Task RemoveByPrefixAsync_WithWildcardPattern_RemovesMatchingKeys()
    {
        ...
        // Assert
        Assert.True(removeResult.Succeeded);
        Assert.False(user1Result.Succeeded);
        Assert.False(user2Result.Succeeded);
        Assert.True(productResult.Succeeded); // Not removed
    }
    ...
    public async Task RemoveByPrefixAsync_WithTenantId_OnlyRemovesTenantData()
    {
        ...
        // Assert
        Assert.False(tenant1Check1.Succeeded);
        Assert.False(tenant1Check2.Succeeded);
        Assert.True(tenant2Check.Succeeded); // Not removed
    }
    ...
    public async Task ClearAsync_WithTenantId_OnlyClearsTenantData()
    {
        ...
        Assert.False(tenant1Check1.Succeeded);
        Assert.False(tenant1Check2.Succeeded);
        Assert.True(tenant2Check.Succeeded);
    }
