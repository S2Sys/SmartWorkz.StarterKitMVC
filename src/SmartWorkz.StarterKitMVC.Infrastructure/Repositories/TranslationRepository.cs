...
/// </summary>
public class TranslationRepository : CachedDapperRepository, ITranslationRepository
{
    public TranslationRepository(IDbConnection connection, IMemoryCache cache, ILogger<TranslationRepository> logger)
